...
C
C     Put getvbtime.x on your path and then run in the directory where
C     the VB2000/GAMESS test set output is, as:-
...
C
      ...
      IOVBOUT = 5
      TOT = 0.0D00
C     36 in the line below is the current number of VB2000/GAMESS tests.
      DO I=1,36
        TIME = 0.0D00
        IF(I.EQ.1) GOTO 2
        IF(I.EQ.2) GOTO 2
